...
const defaultCategories = [
  ...
  { id: '13', key: 'possession', title: 'Topa Sahip Olma', description: 'Hangi takımın daha fazla topa sahip olacağını tahmin edin', emoji: '📊', featured: false, enabled: true, order: 13 },
