// ============================================
// TÜM EKSİK VERİLERİ TAMAMLA
// ============================================
// Bugünkü 75,000 API stokunu kullanarak
...
// ============================================
// PHASE 1: RATING/SKILL (ÖNCELİK #1 - 50,000 API)
// ============================================
...
async function fillRatings(maxCalls) {
  ...
  for (let i = 0; i < sortedTeams.length; i++) {
    ...
    try {
      ...
      while (hasMore && page <= 5 && teamCalls < 10) { // Max 5 sayfa, 10 çağrı
...
async function main() {
  console.log('\n');
  console.log('╔═══════════════════════════════════════════════════════════════════╗');
  console.log('║        TÜM EKSİK VERİLERİ TAMAMLA                                 ║');
  ...
  try {
    // Phase 1: Rating/Skill (50,000 API - EN ÖNEMLİ)
    console.log('\n🎯 ÖNCELİK #1: Rating/Skill');
    results.ratings = await fillRatings(50000);
    console.log(`   [Total API calls: ${apiCalls}]`);
    
    // Phase 2: Kadrolar (15,000 API)
    console.log('\n🎯 ÖNCELİK #2: Kadrolar');
    results.squads = await fillSquads(15000);
    console.log(`   [Total API calls: ${apiCalls}]`);
    
    // Phase 3: Coach (5,000 API)
    console.log('\n🎯 ÖNCELİK #3: Coach');
    results.coaches = await fillCoaches(5000);
    console.log(`   [Total API calls: ${apiCalls}]`);
