...
export function MatchSquad({ matchData, matchId, lineups, favoriteTeamIds = [], predictionTeamId, onComplete, onAttackFormationChangeConfirmed, isVisible = true, isMatchFinished = false, isMatchLive: isMatchLiveProp, onHasUnsavedChanges }: MatchSquadProps) {
  ...
  // ✅ KULLANICI TERCİH İSTATİSTİKLERİNİ YÜKLE (Real Madrid - Barcelona maçı için)
  ...
  React.useEffect(() => {
    ...
    // Real Madrid - Barcelona maçı için mock veri yükle
      ...
      if (userTeamId) {
        ...
        if (prefs) {
          ...
          if (teamLineup?.startXI) {
            const startXI = teamLineup.startXI.map((p: any) => ({
              player: {
                id: p.player?.id || 0,
                name: p.player?.name || '',
  ...
  return (
    <View style={styles.container}>
      <View style={styles.mainContainer}>
        ...
        {isMatchLive && !hasPrediction && userPreferenceStats && autoGeneratedSquad && (
          <View style={styles.preferenceStatsCardNew}>
            ...
            <View style={styles.preferenceStatsRightSection}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => setShowFormationDetailPopup('attack')}
                activeOpacity={0.7}
              >
              ...
              <TouchableOpacity 
                style={styles.preferenceFormationRowClickable}
                onPress={() => setShowFormationDetailPopup('defense')}
                activeOpacity={0.7}
              >
