...
const styles = StyleSheet.create({
  ...
  formationGridContainer: {
    ...
    paddingTop: 4,
    paddingBottom: 24, // ✅ Alt padding - home indicator için boşluk
  ...
  // Player Detail Modal - STANDART POPUP STİLİ
  playerDetailModal: {
    backgroundColor: '#1E3A3A',
    borderTopLeftRadius: 24,
    borderTopRightRadius: 24,
    borderBottomLeftRadius: 0, // ✅ Alt köşeler düz - zemine oturur
    borderBottomRightRadius: 0,
    maxHeight: height * 0.85, // ✅ Ekranın %85'i
    width: '100%',
    maxWidth: 400, // ✅ STANDART: Maksimum genişlik
    borderWidth: 1,
    borderColor: 'rgba(31, 162, 166, 0.2)',
    borderBottomWidth: 0, // ✅ Alt border yok - zemine yapışık
  },
  ...
  playerDetailActions: {
    padding: 16,
    paddingBottom: 32, // ✅ Bottom navigation bar ile çakışmayı önle
    borderTopWidth: 1,
    borderTopColor: 'rgba(255, 255, 255, 0.1)',
  },
