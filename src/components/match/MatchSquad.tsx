  ...
  return (
    <View style={styles.container}>
      <View style={styles.mainContainer}>
        ...
        {/* Popup kapatıldıktan sonra gösterilmeli - Canlı VE biten maçlar için */}
        {isVisible && (isMatchLive || isMatchFinished) && !hasPrediction && !showStartingXIPopup && userPreferenceStats && autoGeneratedSquad && (
...
const styles = StyleSheet.create({
  ...
  formationDetailModal: {
    width: '100%',
    maxWidth: 400, // ✅ STANDART: Maksimum 400px
    maxHeight: '90%',
    borderRadius: 16,
    overflow: 'hidden',
    borderWidth: 1,
  ...
  playerDetailModal: {
    ...
    borderBottomRightRadius: 0,
    // ✅ maxHeight kaldırıldı - içerik kendini belirler, scroll yok
    width: '100%',
    maxWidth: 400,
    borderWidth: 1,
    borderColor: 'rgba(31, 162, 166, 0.2)',
