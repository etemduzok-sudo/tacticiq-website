...
export function MatchSquad({ matchData, matchId, lineups, favoriteTeamIds: favoriteTeamIdsProp = [], predictionTeamId, onComplete, onAttackFormationChangeConfirmed, isVisible = true, isMatchFinished = false, isMatchLive: isMatchLiveProp, allowEditingAfterMatchStart = false, onHasUnsavedChanges, countdownData, countdownTicker = 0, startingXIPopupShown = false, onStartingXIPopupShown }: MatchSquadProps) {
  ...
  React.useEffect(() => {
    ...
    // Mock maçlar için otomatik kadro oluştur (sekme değişince de çalışsın – sahanın altı boş kalmasın)
    if (isMockMatch) {
                ...
                <View style={[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      if (attackFormation) {
                        ...
                        Alert.alert('Kadro Kilitli', 'Formasyon seçmek için önce kilidi açın.');
                      }
                    }}
                    activeOpacity={0.7}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      if (!attackFormation) {
                        Alert.alert('Önce Atak', 'Defans formasyonu seçmek için önce atak formasyonu seçin.');
                        return;
                      }
                    ...
                    return (
                      <View key={f.formation} style={[
                        ...
                        <Text style={styles.formationDetailItemCount}>
                          {communityDataVisible ? `${f.count.toLocaleString()} oy` : '??? oy'}
                        </Text>
                        <View style={[
                          ...
                          ]}>{communityDataVisible ? `%${f.percentage}` : '??%'}</Text>
                        </View>
                      </View>
                    );
                  })}
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <ScrollView style={styles.playerDetailContent} showsVerticalScrollIndicator={false}>
            ...
            {/* ✅ Topluluk Tercihleri - Kullanıcı istatistikleri - SADECE communityDataVisible ise göster */}
            <View style={styles.communityStatsSection}>
              ...
              {communityDataVisible ? (
                ...
                <View style={[styles.communityStatsContainer, { alignItems: 'center', paddingVertical: 20 }]}>
                  <Ionicons name="lock-closed" size={28} color="#9CA3AF" />
                  <Text style={{ color: '#9CA3AF', fontSize: 13, marginTop: 10, textAlign: 'center', lineHeight: 18 }}>
                    Topluluk verileri gizli
                  </Text>
                  <Text style={{ color: '#6B7280', fontSize: 11, marginTop: 4, textAlign: 'center' }}>
                    Tahminlerinizi kaydedin ve topluluk tercihlerini görün!
                  </Text>
                </View>
              )}
            </View>
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    ...
    maxWidth: 400, // ✅ STANDART: Maksimum genişlik (web'de dar görünsün)
  ...
  // Player Detail Modal - STANDART POPUP STİLİ (alttan açılır, zemine yapışık)
  playerDetailModal: {
    backgroundColor: '#1E3A3A',
    borderTopLeftRadius: 24,
    borderTopRightRadius: 24,
    ...
    borderColor: 'rgba(31, 162, 166, 0.2)',
    borderBottomWidth: 0,
    marginBottom: 0, // ✅ Zemine yapışık
    paddingBottom: Platform.OS === 'web' ? 16 : 34, // ✅ Web için minimal, iOS için home indicator
  },
  playerDetailHeader: {
    padding: 20,
    paddingTop: 16,
