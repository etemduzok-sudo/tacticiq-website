...
export function MatchSquad({ matchData, matchId, lineups, favoriteTeamIds: favoriteTeamIdsProp = [], predictionTeamId, onComplete, onAttackFormationChangeConfirmed, isVisible = true, isMatchFinished = false, isMatchLive: isMatchLiveProp, onHasUnsavedChanges, startingXIPopupShown = false, onStartingXIPopupShown, hasViewedCommunityData = false }: MatchSquadProps) {
  ...
  const KADRO_LOCKED_MESSAGE = 'Maç başladığı için kadro kurulumu yapılamaz.';
  const showKadroLockedToast = () => showInfo('Kadro kilitli', KADRO_LOCKED_MESSAGE);
  ...
  const handlePlayerSelect = (player: typeof players[0]) => {
    ...
    if (selectedSlot !== null) {
      ...
      if (isGK && slotPosition !== 'GK') {
        showInfo('Kaleci Kısıtlaması', 'Kaleci sadece kale pozisyonuna yerleştirilebilir.');
        return;
      }
      if (slotPosition === 'GK' && !isGK) {
        showInfo('Kale Pozisyonu', 'Kale pozisyonuna sadece kaleci yerleştirilebilir.');
        return;
      }
  ...
  const handleRemovePlayer = async (slotIndex: number) => {
    ...
    if (isSquadLocked) {
      showInfo('Kadro Kilitli', 'Oyuncu çıkarmak için önce kilidi açın.');
      return;
    }
  ...
  const handleComplete = async () => {
    ...
    if (attackCount < 11) {
      showInfo('Atak Kadrosu Eksik!', `Atak için ${11 - attackCount} oyuncu daha seçmelisiniz.`);
      setEditingMode('attack');
      return;
    }
    ...
    if (defenseFormation && defenseCount < 11) {
      showInfo('Defans Kadrosu Eksik!', `Defans için ${11 - defenseCount} oyuncu daha yerleştirmelisiniz.`);
      setEditingMode('defense');
      return;
    }
    ...
    try {
      ...
      showInfo('Hata!', 'Kadro kaydedilemedi. Lütfen tekrar deneyin.');
    }
  };
        ...
        <View style={styles.emptyStateContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              if (isSquadLocked) {
                showInfo('Kadro Kilitli', 'Formasyon değiştirmek için önce kilidi açın.');
                return;
              }
              setShowFormationModal(true);
            }}
                ...
                <View style={[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      if (attackFormation) {
                        ...
                        showInfo('Kadro Kilitli', 'Formasyon seçmek için önce kilidi açın.');
                      }
                    }}
                    activeOpacity={0.7}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      if (!attackFormation) {
                        showInfo('Önce Atak', 'Defans formasyonu seçmek için önce atak formasyonu seçin.');
                        return;
                      }
          ...
          <View style={styles.playerDetailContentNoScroll}>
            ...
            <View style={styles.additionalInfoCompact}>
              <View style={styles.infoChip}>
                ...
                <Text style={styles.infoChipText}>Form: {player.form}/10</Text>
              </View>
              <View style={styles.infoChip}>
              ...
              <View style={styles.infoChip}>
                ...
                <Text style={styles.infoChipText}>{player.age} yaş</Text>
              </View>
            </View>
            
            {/* ✅ Topluluk Tercihleri - Kompakt versiyon */}
            <View style={styles.communityStatsSectionCompact}>
              <Text style={styles.playerDetailSectionTitleCompact}>👥 Topluluk Tercihleri</Text>
              
              {communityDataVisible ? (
                communityStats.loading ? (
                  <View style={styles.communityStatsCompactLoading}>
                    <Text style={{ color: '#64748B', fontSize: 12 }}>Yükleniyor...</Text>
                  </View>
                ) : (
                  <View style={styles.communityStatsCompactRow}>
                    {/* İlk 11'de görmek isteyenler */}
                    <View style={styles.communityStatChip}>
                      <Ionicons name="football" size={14} color="#1FA2A6" />
                      <Text style={styles.communityStatChipLabel}>İlk 11</Text>
                      <Text style={[
                    ...
                    {positionLabel && (
                      <View style={styles.communityStatChip}>
                        ...
                        <Text style={styles.communityStatChipLabel}>{positionLabel}</Text>
                        <Text style={[
                          styles.communityStatChipValue,
                ...
                <View style={styles.communityStatsCompactLocked}>
                  <Ionicons name="lock-closed" size={16} color="#9CA3AF" />
                  <Text style={styles.communityStatsCompactLockedText}>
