...
const styles = StyleSheet.create({
  ...
  pointsSummary: { backgroundColor: 'rgba(255, 255, 255, 0.5)', borderRadius: 8, padding: 16, marginBottom: 12 },
  ...
  breakdownItem: { flex: 1, minWidth: '47%', backgroundColor: 'rgba(148, 163, 184, 0.2)', borderRadius: 8, padding: 12, alignItems: 'center' },
  breakdownItemBonus: { backgroundColor: 'rgba(5, 150, 105, 0.1)', borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)' },
  breakdownValue: { fontSize: 18, fontWeight: 'bold', color: '#0F172A', marginBottom: 4 },
  breakdownValueBonus: { fontSize: 18, fontWeight: 'bold', color: '#059669', marginBottom: 4 },
  ...
  accuracyItem: { flex: 1, backgroundColor: 'rgba(148, 163, 184, 0.2)', borderRadius: 8, padding: 8, alignItems: 'center' },
  accuracyItemCorrect: { flex: 1, backgroundColor: 'rgba(5, 150, 105, 0.1)', borderRadius: 8, padding: 8, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)' },
  accuracyIconRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 4 },
  accuracyValue: { fontSize: 16, fontWeight: 'bold', color: '#0F172A' },
  accuracyValueCorrect: { fontSize: 16, fontWeight: 'bold', color: '#059669' },
  ...
  predictionCardCorrect: { backgroundColor: 'rgba(5, 150, 105, 0.1)', borderColor: 'rgba(5, 150, 105, 0.2)' },
  predictionCardWrong: { backgroundColor: 'rgba(148, 163, 184, 0.1)', borderColor: '#E2E8F0' },
  predictionContent: { flex: 1 },
  predictionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  predictionName: { fontSize: 14, fontWeight: 'bold', color: '#0F172A', flex: 1 },
  predictionDetails: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' },
  predictionDetailText: { fontSize: 10, color: '#64748B' },
  predictionDetailValue: { fontWeight: '600', color: '#0F172A' },
  ...
  comparisonCard: { backgroundColor: 'rgba(5, 150, 105, 0.1)', borderRadius: 8, padding: 16, borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)' },
  comparisonText: { fontSize: 14, color: '#0F172A', marginBottom: 12 },
  comparisonHighlight: { fontSize: 18, fontWeight: 'bold', color: '#059669' },
  comparisonStats: { flexDirection: 'row', gap: 12, marginBottom: 12 },
  comparisonStatItem: { flex: 1, alignItems: 'center' },
  comparisonStatLabel: { fontSize: 12, color: '#64748B', marginBottom: 4 },
  comparisonStatValue: { fontSize: 16, fontWeight: 'bold', color: '#0F172A' },
  ...
  distributionBarContainer: { flex: 1, height: 20, backgroundColor: '#E2E8F0', borderRadius: 4, overflow: 'hidden', position: 'relative' },
  distributionBar: { height: '100%', backgroundColor: 'rgba(100, 116, 139, 0.3)', justifyContent: 'center', alignItems: 'flex-end', paddingRight: 8 },
  distributionBarUser: {},
  ...
  tag: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(5, 150, 105, 0.05)', borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 8 },
  tagIcon: { fontSize: 14 },
  tagLabel: { fontSize: 10, fontWeight: 'bold', color: '#0F172A' },
  tagNote: { fontSize: 9, color: '#64748B', fontStyle: 'italic' },
  performanceComparison: { backgroundColor: 'rgba(148, 163, 184, 0.15)', borderRadius: 8, padding: 12, marginBottom: 12 },
  performanceRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  performanceLabel: { fontSize: 10, color: '#64748B', textTransform: 'uppercase', letterSpacing: 0.5 },
  performanceValue: { fontSize: 14, fontWeight: 'bold', color: '#0F172A' },
  ...
  recentMatches: { gap: 6 },
  recentMatchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(148, 163, 184, 0.1)', borderRadius: 8, padding: 8 },
  recentMatchLeft: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  recentMatchDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#64748B' },
  recentMatchDotActive: { backgroundColor: '#059669' },
  recentMatchOpponent: { fontSize: 11, color: '#0F172A' },
  recentMatchRight: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  recentMatchDate: { fontSize: 9, color: '#64748B' },
  recentMatchPoints: { fontSize: 12, fontWeight: 'bold', color: '#0F172A' },
  extremesGrid: { flexDirection: 'row', gap: 8, marginTop: 12 },
  extremeItem: { flex: 1, backgroundColor: 'rgba(148, 163, 184, 0.15)', borderRadius: 8, padding: 8, alignItems: 'center' },
  extremeItemBest: { flex: 1, backgroundColor: 'rgba(5, 150, 105, 0.1)', borderRadius: 8, padding: 8, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)' },
  extremeLabel: { fontSize: 9, color: '#64748B', textTransform: 'uppercase', marginBottom: 4 },
  extremeValue: { fontSize: 16, fontWeight: 'bold', color: '#0F172A' },
  extremeValueBest: { fontSize: 16, fontWeight: 'bold', color: '#059669' },
  privacyNote: { backgroundColor: 'rgba(148, 163, 184, 0.1)', borderWidth: 1, borderColor: '#E2E8F0', borderStyle: 'dashed', borderRadius: 8, padding: 12 },
  ...
  standingRow: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 8, borderRadius: 8, backgroundColor: 'rgba(148, 163, 184, 0.1)' },
  standingRowUser: { backgroundColor: 'rgba(5, 150, 105, 0.1)', borderLeftWidth: 3, borderLeftColor: '#059669' },
  standingRank: { width: 24, height: 24, borderRadius: 6, backgroundColor: '#E2E8F0', justifyContent: 'center', alignItems: 'center' },
  standingRankUser: { backgroundColor: '#059669' },
  standingRankText: { fontSize: 10, fontWeight: 'bold', color: '#64748B' },
  standingRankTextUser: { color: '#FFF' },
  standingTeam: { flex: 1, fontSize: 12, fontWeight: '600', color: '#0F172A' },
  standingStat: { fontSize: 12, fontWeight: '600', color: '#64748B', width: 32, textAlign: 'center' },
  standingPoints: { fontSize: 14, fontWeight: 'bold', color: '#0F172A', width: 32, textAlign: 'center' },
  ...
  streakCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(245, 158, 11, 0.1)', borderRadius: 8, padding: 12, borderWidth: 1, borderColor: 'rgba(245, 158, 11, 0.2)' },
  streakContent: { flex: 1 },
  streakValue: { fontSize: 18, fontWeight: 'bold', color: '#0F172A', marginBottom: 2 },
  streakLabel: { fontSize: 12, color: '#64748B' },
  venueStatsContainer: { gap: 12 },
  venueCard: { backgroundColor: 'rgba(148, 163, 184, 0.05)', borderRadius: 8, padding: 12 },
  venueHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12 },
  venueTitle: { fontSize: 14, fontWeight: 'bold', color: '#0F172A' },
  venueStats: { flexDirection: 'row', gap: 12 },
  venueStat: { flex: 1, alignItems: 'center' },
  venueStatLabel: { fontSize: 10, color: '#64748B', marginBottom: 4 },
  venueStatValue: { fontSize: 16, fontWeight: 'bold', color: '#0F172A' },
});
