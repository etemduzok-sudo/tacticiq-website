                    ...
                    >
                      <View style={styles.dropdownItemContent}>
                        ...
                        <View style={[
                          ...
                          { backgroundColor: getNationalTeamColors(countryName)[0] }
                        ]}>
                          {item.match(/[\u{1F1E6}-\u{1F1FF}]{2}/u) && (
                            <Text style={styles.flagEmoji}>
                              {item.match(/[\u{1F1E6}-\u{1F1FF}]{2}/u)?.[0]}
                            </Text>
                          )}
                        </View>
                      ...
                      {isSelected && (
                        <Ionicons name="checkmark" size={20} color={WEBSITE_BRAND_COLORS.primary} />
                      )}
                    </TouchableOpacity>
                  );
                }}
