...
Görsel açıklamasına göre logo:
- **Şekil:** Kalkan (shield) şeklinde
...
Logo otomatik olarak SplashScreen'de gösterilecek.

Eğer logo dosyası yoksa, uygulama boş logo alanı ile çalışmaya devam edecek (hata vermez).
